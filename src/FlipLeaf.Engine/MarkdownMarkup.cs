...
public sealed partial class MarkdownMarkup : IMarkdownMarkup
{
    ...
    public sealed class FlipLeafPageHtmlRender : HtmlRenderer
    {
    ...
    /// </summary>
    internal sealed partial class SyntaxHighlightCodeBlockExtension : IMarkdownExtension
    {
        /// <inheritdoc/>
    ...
    /// </summary>
    internal sealed partial class SnippetCodeBlockExtension : IMarkdownExtension
    {
